                    ...
                    <div class="card shadow my-4">
                        <div class="card-body">
                            <div class="row align-items-center my-4">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <div class="p-4">
                                                ...
                                                <span class="h2 mb-0">10 dias</span>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="p-4">
                                                <p class="text-uppercase mb-0">Fondo de ahorro</p>
                                                <span class="h2 mb-0">$70000</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row align-items-center">
                                ...
                                <div class="col-md-8">
                                    <div class="mr-4">
                                        <img src="./assets/images/fachada.png" alt="..." class="avatar-img rounded-circle" style="width: 100%">
                                    </div>
                                </div> <!-- .col-md-8 -->
                            </div> <!-- end section -->
                        </div> <!-- .card-body -->
